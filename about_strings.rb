...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Because, it does in-place mutation. << makes sure that the variable hi
    # and original_string share the same object_id.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # Not really? what is there to be surprised? The whole
    # mutations here surprises me, and don't know who discovered this!
  end
