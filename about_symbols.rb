...
class AboutSymbols < Neo::Koan
  ...
  #
    ...
    # because symbol comparison means u r comparing object ID and not the content
    # of the identifier that refers to this symbol. But not sure, if that is really a problem.
